...
module soc_system_mm_interconnect_0 (
	...
	wire  [129:0] pio_dataout_s1_agent_rf_source_data;                                                // pio_dataout_s1_agent:rf_source_data -> pio_dataout_s1_agent_rsp_fifo:in_data
	...
	wire  [129:0] pio_dataout_s1_agent_rsp_fifo_out_data;                                             // pio_dataout_s1_agent_rsp_fifo:out_data -> pio_dataout_s1_agent:rf_sink_data
	...
	wire          pio_dataout_s1_agent_rp_valid;                                                      // pio_dataout_s1_agent:rp_valid -> router_009:sink_valid
	wire  [128:0] pio_dataout_s1_agent_rp_data;                                                       // pio_dataout_s1_agent:rp_data -> router_009:sink_data
	wire          pio_dataout_s1_agent_rp_ready;                                                      // router_009:sink_ready -> pio_dataout_s1_agent:rp_ready
	wire          pio_dataout_s1_agent_rp_startofpacket;                                              // pio_dataout_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          pio_dataout_s1_agent_rp_endofpacket;                                                // pio_dataout_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [128:0] pio_enable_s1_agent_rp_data;                                                        // pio_enable_s1_agent:rp_data -> router_010:sink_data
	...
	wire          pio_instruction_s1_agent_rp_valid;                                                  // pio_instruction_s1_agent:rp_valid -> router_011:sink_valid
	wire  [128:0] pio_instruction_s1_agent_rp_data;                                                   // pio_instruction_s1_agent:rp_data -> router_011:sink_data
	wire          pio_instruction_s1_agent_rp_ready;                                                  // router_011:sink_ready -> pio_instruction_s1_agent:rp_ready
	wire          pio_instruction_s1_agent_rp_startofpacket;                                          // pio_instruction_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          pio_instruction_s1_agent_rp_endofpacket;                                            // pio_instruction_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire  [128:0] pio_flags_s1_agent_rp_data;                                                         // pio_flags_s1_agent:rp_data -> router_012:sink_data
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> pio_dataout_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_dataout_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // pio_dataout_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_dataout_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> pio_dataout_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> pio_dataout_s1_burst_adapter:sink0_endofpacket
	wire          pio_dataout_s1_burst_adapter_source0_valid;                                         // pio_dataout_s1_burst_adapter:source0_valid -> pio_dataout_s1_agent:cp_valid
	wire  [128:0] pio_dataout_s1_burst_adapter_source0_data;                                          // pio_dataout_s1_burst_adapter:source0_data -> pio_dataout_s1_agent:cp_data
	wire          pio_dataout_s1_burst_adapter_source0_ready;                                         // pio_dataout_s1_agent:cp_ready -> pio_dataout_s1_burst_adapter:source0_ready
	wire    [7:0] pio_dataout_s1_burst_adapter_source0_channel;                                       // pio_dataout_s1_burst_adapter:source0_channel -> pio_dataout_s1_agent:cp_channel
	...
	wire  [128:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_enable_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                              // pio_enable_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_enable_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> pio_instruction_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_instruction_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                              // pio_instruction_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> pio_instruction_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> pio_instruction_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> pio_instruction_s1_burst_adapter:sink0_endofpacket
	...
	wire    [7:0] pio_instruction_s1_burst_adapter_source0_channel;                                   // pio_instruction_s1_burst_adapter:source0_channel -> pio_instruction_s1_agent:cp_channel
	...
	wire  [128:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> pio_flags_s1_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                              // pio_flags_s1_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> pio_flags_s1_burst_adapter:sink0_channel
	...
	wire          pio_dataout_s1_agent_rdata_fifo_out_valid;                                          // pio_dataout_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] pio_dataout_s1_agent_rdata_fifo_out_data;                                           // pio_dataout_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          pio_dataout_s1_agent_rdata_fifo_out_ready;                                          // avalon_st_adapter_004:in_0_ready -> pio_dataout_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> pio_dataout_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> pio_dataout_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // pio_dataout_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> pio_dataout_s1_agent:rdata_fifo_sink_error
	...
	wire          pio_instruction_s1_agent_rdata_fifo_out_valid;                                      // pio_instruction_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] pio_instruction_s1_agent_rdata_fifo_out_data;                                       // pio_instruction_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          pio_instruction_s1_agent_rdata_fifo_out_ready;                                      // avalon_st_adapter_006:in_0_ready -> pio_instruction_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> pio_instruction_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> pio_instruction_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // pio_instruction_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> pio_instruction_s1_agent:rdata_fifo_sink_error
