	soc_system u0 (
		...
		.instruction_export                    (<connected-to-instruction_export>),                    //               instruction.export
		.enable_export                         (<connected-to-enable_export>),                         //                    enable.export
		.dataout_export                        (<connected-to-dataout_export>),                        //                   dataout.export
		.flags_export                          (<connected-to-flags_export>)                           //                     flags.export
	);
